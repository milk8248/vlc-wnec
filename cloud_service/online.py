...
def on_image_received(input_image_path):
	...
	origin_location = numpy.array(origin_location.split(','))
	origin_location = origin_location.astype(numpy.float)
	...
	try:
		rx_location, rx_rotation, location_error, lights_info, rx_location_fp = aoa_full(
				input_image_path,
				camera,
				room,
		...
		logger.primary('rx_location_fp = {}'.format(rx_location_fp))
		...
		# #req = urllib2.Request('http://ec2-34-199-123-122.compute-1.amazonaws.com:3000/user')
